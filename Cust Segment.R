...
# using rfm model to segment customers
...
#####
# Now we have 4 groups of customers which are good, leaved, leaving and new customers, we have 1 more group called monitoring customer group
